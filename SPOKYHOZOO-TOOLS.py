...
{red}
                                      ...
                                      \033[1;32mCoded By :SPOKYHOZOO
            
                                  \033[1;33mTITOK :SPOKYHOZOO
""")
time.sleep(0.2)
...
█░█ █▀█ █░▀█ █▄▀ █▄█ █▀▄ █▀█                               
                              \033         
    """)
    print(info + f"Note : This tools made by SPOKYHOZOO, This tools is for jammering wifi like, Make the wifi connection slow.")
...
""")
    ...
    for nick in nick_lines:
        for password in password_lines:
            ...
            print(green + f"---------------------------")
            print(info + f"Trying Nick: {HOZOO}")
            print(f"Password: {HOZOO}")
            print(green + f"---------------------------")
            headers = {}
    ...
    print('')
    print(f'\033[37m')
    print(f"╭─[{yellow} SPOKYHOZOO@localhost {white} ~/more")
    answer = input("╰─$ ")
